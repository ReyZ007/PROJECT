  ...
  getTasksByCategory(category) {
    try {
      ...
      return {
        ...
        category: category,
        categoryDisplayName: this._getCategoryDisplayName(category),
      };
    } catch (error) {
      return {
        success: false,
  ...
  updateTaskCategory(taskId, newCategory) {
    try {
      ...
      return {
        success: true,
        data: updatedTask,
        message: `Kategori task berhasil diubah ke ${this._getCategoryDisplayName(newCategory)}`,
      };
    } catch (error) {
      return {
        success: false,
  ...
  getAvailableCategories() {
    try {
      ...
      const categoriesWithDisplay = categories.map((category) => ({
        value: category,
        label: this._getCategoryDisplayName(category),
      }));
